...
(function () {
  ...
  function VoidClassWindowNodeJs() { return undefined; }
  if (__isNodeJs__) { $window = new VoidClassWindowNodeJs(); }
    ...
    Class.extend = function (src_name, src) {
            ...
            ppt[name$] = (typeof src[name$] === "function") ? (
              function (name$, fn) {
                return function () {
                  ...
                  if (hs) {
                    this.__super = function () { return protectedCall(this, __super[name$], arguments); };
                  }
      ...
      function constructorInit() {
        ...
        if (vl) {
          ...
          // Constructor
          if (t.__constructor) {
            protectedCall(t, t.__constructor, arguments);
          }
